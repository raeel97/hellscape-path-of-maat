...
def sphinx_death():
    print("""
    The sphinx lunges forward and knocks you backward. She lands on your chest
    crushing your windpipe and ribs beneath her weight.
    """)
    time.sleep(5)
    print("""
    Choking on your blood you see her head splitting open horizonatally from 
    the edges of her mouth to her ears, your realize that shes opening her 
    mouth to reveal rows of razor sharp teeth
    """)
    time.sleep(5)
    print("""
    As you scream, all you hear is the sound of your blood gurgling, wetly, in 
    back of your throat. She strikes forward like a snake. 
    """)
    time.sleep(5)
    print("""
    With dawning horror, you realize because you are already dead, there is 
    no end to this. 
    You pray to god to save you but you spend the rest of eternity being torn 
    open and toyed with by the sphinx. 
    """)
    time.sleep(10)    
    restart_game()
...
def sphinx_choice_two_one():
    ...
    time.sleep(5)
    print("""
    With a warcry that reeks of fear, you rush forward, aiming for the heart!
    """)
    time.sleep(5)
    print("""
...
def sphinx_choice_two_two():
    print("""
    Shaking like a leaf, your voice cracks as you ask “Do you speak English?”  
    """)
    time.sleep(5)
    print("""
    ...
    time.sleep(5)
    print("""
    The sphinx replies “It would be in your best interest to not get it wrong”  
    """)
    sphinx_riddle()
...
def sphinx_final():
    time.sleep(5)
    print("""
    The sphinx stares at you. In its eyes you can detect the smallest glimmer
    of pride.  
    """)
    time.sleep(5)
    print("""
    The sphinx taps her paw against the ground. A loud rumble fills the room. 
    """)
    time.sleep(5)
    print("""
    ...
    in its voice. 
    It informs you, that you may continue your journey along the path of maat. 
    """)
    time.sleep(5)
    print("""
